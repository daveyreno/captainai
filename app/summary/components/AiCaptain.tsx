            ...
            <div className="flex flex-col gap-4 p-6 overflow-y-scroll border-b scrollbar-thin bg-slate-50 border-x h-80 scrollbar-thumb-slate-500 scrollbar-track-slate-200">
                <div className="flex justify-end">
                    <div className="w-2/3 p-4 rounded-lg bg-slate-200">
                        👋 Hi Barry! It&apos;s me,{" "}
                        <span className="font-semibold">AI Captain</span>. I&apos;m an AI model that can chat to you to improve the chances of success on this app. I noticed your Quality Score&reg; is currently 20. I can help you improve it, if you would like my help just ask.
                    </div>
                </div>
                <div className="flex">
                ...
                <div className="flex justify-end">
                    <div className="w-2/3 p-4 rounded-lg bg-slate-200">
                        The best way to improve the Quality Score&reg; on this application is to complete the todo items.
                    </div>
                </div>
                ...
                <div className="flex justify-end">
                    <div className="w-2/3 p-4 rounded-lg bg-slate-200">
                        Well done Barry, the Quality Score&copy; is now at 57. You can improve his by elaborating on the{" "}
