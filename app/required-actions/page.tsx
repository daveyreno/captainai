        ...
        <div className='flex justify-center'>
            <div className='flex flex-col w-full max-w-6xl gap-4 p-6 md:p-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-center gap-1 py-6 bg-white border-b border-x text-slate-500'>There are currently <span className='font-bold text-slate-800'>14 outstanding</span> items.</div>

                    <div className='flex flex-col justify-center gap-2 p-3 bg-white border-b md:flex-row border-x'>

                        <div className='flex items-center justify-between p-3 bg-white border rounded-lg cursor-pointer hover:bg-slate-50'>
                            <p className='ml-2 mr-10'>Conditions</p>
                            <svg xmlns="http://www.w3.org/2000/svg" height='20' viewBox="0 0 24 24" id="angle-down"><path fill="#%236563FF" d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"></path></svg>
                        </div>

                        <div className='flex items-center justify-between p-3 bg-white border rounded-lg cursor-pointer hover:bg-slate-50'>
                            <p className='ml-2 mr-10'>Progress</p>
                            <svg xmlns="http://www.w3.org/2000/svg" height='20' viewBox="0 0 24 24" id="angle-down"><path fill="#%236563FF" d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"></path></svg>
                        </div>

                        <div className='flex items-center justify-between p-3 bg-white border rounded-lg cursor-pointer hover:bg-slate-50'>
                            <p className='ml-2 mr-10'>Type</p>
                            <svg xmlns="http://www.w3.org/2000/svg" height='20' viewBox="0 0 24 24" id="angle-down"><path fill="#%236563FF" d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"></path></svg>
                        </div>
                    ...
                    <div className='flex flex-col p-6 border-b border-bborder-x bg-slate-50 border-x'>
                        ...
                        <div className='flex flex-col items-end justify-end gap-4 p-6 bg-white border-b border-x'>
                            ...
                            <button className='p-4 text-sm font-semibold tracking-widest text-white uppercase transition duration-300 bg-teal-500 rounded-lg lg:px-6 hover:bg-teal-600'>Save</button>
                        </div>
