        ...
        <div className='flex justify-center'>
            <div className='flex flex-col w-full max-w-6xl gap-4 p-6 md:p-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex gap-2 p-3 bg-white border-b border-x'>

                        <div className='flex items-center p-3 border rounded-lg hover:slate-100 '>
                            <p className='ml-2 mr-10'>Option</p>
