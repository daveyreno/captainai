        ...
        <div className='flex justify-center'>
            <div className='flex flex-col w-full max-w-6xl gap-4 p-6 md:p-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col p-6 border-b bg-slate-50 border-x'>


                        <div className='border'>
                            <div className='text-lg'>Exit Strategy Required</div>
                            <textarea class="block w-full px-4 py-3 text-lg border border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 " rows="3"></textarea>
