...
function Header() {
    return (
        <div className='flex justify-between p-5 text-white md:p-4 animate-gradient-x bg-gradient-to-r from-slate-800 via-teal-700 to-blue-600'>
            ...
            <div className='flex items-center justify-center w-12 h-12 transition duration-300 border-2 border-white rounded-full cursor-pointer hover:bg-slate-900 hover:border-slate-900 hover:bg-opacity-40 hover:border-0'>
